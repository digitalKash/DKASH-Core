...
Value pubkeyaliasservice(const Array& params, bool fHelp)
{
    ...
    if (fHelp  ||
        ...
        throw runtime_error(
                ...
                "  start        - Start pubkeyaliasservice configured in DigitalKash.conf\n"
                ...
                "  stop         - Stop pubkeyaliasservice configured in DigitalKash.conf\n"
    ...
    if(strCommand == "status")
    {
        ...
        if (ppas) mnObj.push_back(Pair("pubkey", CDigitalKashAddress(ppas->pubkey.GetID()).ToString()));
