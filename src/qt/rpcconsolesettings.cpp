...
/**
 * Split DigitalKash command line into a list of arguments. Aims to emulate \c bash and friends.
 *
...
void RPCConsolesettings::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the DigitalKash RPC console.") + "<br>" +
...
void RPCConsolesettings::setMasternodeCount(const QString &strMasternodes)
{
