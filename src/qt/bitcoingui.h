...
/**
  DigitalKash GUI main class. This class represents the main window of the DigitalKash UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DigitalKashGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit DigitalKashGUI(QWidget *parent = 0);
    ~DigitalKashGUI();
    ...
    */
    ...
    /** Set the message model.
        The message model represents a DigitalKash  Note or D-Note, and offers secure messaging through a peer to peer
        relay.
    */
...
private slots:
    ...
    */
    ...
    /** Edit the DigitalKash.conf file */
    void editConfig();
    void editConfigExt();
