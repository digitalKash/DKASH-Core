...
/** DigitalKash unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DigitalKashUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DigitalKashUnits(QObject *parent);
...
typedef DigitalKashUnits::Unit DigitalKashUnit;
