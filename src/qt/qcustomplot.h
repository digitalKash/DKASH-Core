...
class QCP_LIB_DECL QCPAxis : public QCPLayerable
{
  ...
  Q_PROPERTY(bool rangeDigitalKashersed READ rangeDigitalKashersed WRITE setRangeDigitalKashersed)
...
public:
  ...
  */
  ...
  bool rangeDigitalKashersed() const { return mRangeDigitalKashersed; }
  ...
  void setRangeDigitalKashersed(bool reversed);
