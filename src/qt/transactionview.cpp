...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    // Replace "," by "." so DigitalKashUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if(DigitalKashUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(DigitalKashUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(DigitalKashUnits::formatWithUnit(nDisplayUnit, amount, true, DigitalKashUnits::separatorAlways));
