...
// -- get at the data
class CDigitalKashAddress_B : public CDigitalKashAddress
{
public:
    uint8_t getVersion()
    {
...
public:
    ...
    ~SecMsgCrypter()
    {
        ...
        LockedPageManager::Instance().UnlockRange(&chKey[0], sizeof chKey); // Messaging enabled
        LockedPageManager::Instance().UnlockRange(&chIV[0], sizeof chIV); // Messaging enbaled
    }
